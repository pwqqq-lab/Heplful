<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entrance.aspx.cs" Inherits="便民服务.Entrance" %>
        ...
        <div>
			...
			<div class="content content--intro">
				...
				<div class="content__inner">
					...
					<a href="#" class="enter">欢迎进入RanWei~</a>
				</div>
			...
			<div class="content content--fixed">
				<div class="content__inner">
					<!-- 主页内容 -->
					<nav class="menu">
						<a class="menu__item" href="HomePage.aspx" style="background: no-repeat 0% 44%/94% url(img/paint1.svg);"><span>游客访问</span></a>
						<a class="menu__item" href="Login.aspx" style="background: no-repeat 0% 30%/94% url(img/paint2.svg);"><span>登录/注册</span></a>
					</nav>
